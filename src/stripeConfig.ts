...
/**
 * BlackWayConnect checkouts use BlackWay's OWN live Stripe Payment Links
 * (merchant acct_1TDZjzAG7HUL9Rtr), defined in `PLANS` above. They must NEVER
 * hand off to vorixa.ca: BlackWay and Vorixa are separate businesses with
 * separate Stripe accounts, pricing and payment links.
 */
...
export function checkoutUrl(
  ...
  // BlackWay's own live Stripe Payment Link — never vorixa.ca.
  const url = new URL(PLANS[plan].paymentLink);
