"""
BlackWayConnect - Stripe Payment Processing
Gère les checkout sessions, webhooks et abonnements.
Intègre le module delivery.py pour création automatique de tâches Asana.

Prix Stripe configurés (CAD):
- Site & Présence Google: 1,495$ (price_1TyIHGAG7HUL9RtrPWz5NYI3)
- Automatisation & IA:    4,995$ (price_1TyIHFAG7HUL9RtrvhJ6ymFc)
- Conversion & CRM:       6,995$ (price_1TyIHGAG7HUL9RtrNKjKE19h)
"""
...
PRICE_IDS = {
    ...
    "conversion_crm": {
        ...
        "monthly": "price_1TxzdNAG7HUL9RtrSOMETHING",
    ...
    "automatisation_ia": {
        ...
        "monthly": "price_1TxzdOAG7HUL9RtrSOMETHING",
